...
public class ItemInfoVO {
	...
	public ItemInfoVO(String subjects, String machinery, String assembly, String item, String part1, String part2,
			String key2, int esti_unit_price, String clients, String currency) {
		super();
	...
	public String toString() {
		return "ItemVO [subjects=" + subjects + ", machinery=" + machinery + ", assembly=" + assembly + ", item=" + item
				+ ", part1=" + part1 + ", part2=" + part2 + ", key2=" + key2 + ", esti_unit_price=" + esti_unit_price
